...
const file_proto_notification_v1_notification_proto_rawDesc = "" +
	"\n" +
	"(proto/notification/v1/notification.proto\x12\x0fnotification.v1\"P\n" +
	...
	"\n" +
	"message_id\x18\x01 \x01(\tR\tmessageId2i\n" +
	"\x13NotificationService\x12R\n" +
	"\tSendEmail\x12!.notification.v1.SendEmailRequest\x1a\".notification.v1.SendEmailResponseB:Z8erdinhrmwn/bangunin/proto/notification/v1;notificationv1b\x06proto3"
